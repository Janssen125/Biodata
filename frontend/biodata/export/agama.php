...
$no = 1;
$unique = $_GET['unique'];
$rows = mysqli_query($db, "SELECT * FROM biodata WHERE agama = $unique ORDER BY agama ASC");
...
<center>
                        <table border=1 cellpadding=10 cellspacing = 0>
                            <thead>
                                <tr>
                                <th style='text-align:center;' colspan=9> Data Per Agama </th>
                                </tr>
                                <tr>
                                <th>
                                No
                            ...
                            foreach($rows as $row) {
                                ?>
                                    ...
                                    <td style='text-align:center;background-color:lightgrey;'><?= $row['agama'] ?></td>
