...
$no = 1;
$unique = $_GET['unique'];
$rows = mysqli_query($db, "SELECT * FROM biodata WHERE status_karyawan = $unique ORDER BY status_karyawan ASC");
...
<center>
                        <table border=1 cellpadding=10 cellspacing = 0>
                            <thead>
                                <tr>
                                <th style='text-align:center;' colspan=8> Data Per Status Karyawan </th>
                                </tr>
                                <tr>
                                <th>
                                No
                            ...
                            while($row = mysqli_fetch_array($rows)){
                                ?>
                                    ...
                                    <td style='text-align:center;background-color:lightgrey;'><?= $row['status_karyawan'] ?></td>
