        ...
        <div class="d-flex align-items-end">
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form method="post" action="../../proses/berkas/tambah.php" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $row['id'] ?>">
                        <div class="form-group">
                            <label for="">Nama</label>
                            <input type="text" class="form-control" name="nama" value="<?= $row['nama_lengkap'] ?>" readonly>
                        </div>
                        <br>
                        <div class="form-group">
                    ...
                    $query0 = mysqli_query($db, "SELECT COUNT(*) as jmlh FROM berkas WHERE nama = '$nama'");
