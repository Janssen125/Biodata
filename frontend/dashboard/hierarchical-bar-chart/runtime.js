// @observablehq/runtime v5.4.2 Copyright 2023 Observable, Inc.
function e(e, t, n) {
    n = n || {};
...
function L(e, n, a, o) {
    let i, s, c, l, u = t(e);
    if (e instanceof Map ? e instanceof e.constructor ? (i = `Map(${e.size})`, s = k) : (i = "Map()", s = U) : e instanceof Set ? e instanceof e.constructor ? (i = `Set(${e.size})`, s = M) : (i = "Set()", s = U) : u ? (i = `${e.constructor.name}(${e.length})`, s = P) : (l = h(e)) ? (i = `Immutable.${l.name}${"Record"===l.name?"":`(${e.size})`}`, u = l.arrayish, s = l.arrayish ? R : l.setish ? I : D) : (i = d(e), s = U), n) {
        const t = document.createElement("span");
    ...
    p.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M7 4L1 8V0z' fill='currentColor' />\n  </svg>", p.appendChild(document.createTextNode(`${i}${u?" [":" {"}`)), f.addEventListener("mouseup", (function (t) {
        O(f) || (t.stopPropagation(), ie(f, v(e, 0, a, o)))
    }), !0), s = s(e);
...
const Ne = Ce("d3", "7.8.2", "dist/d3.min.js"),
    ...
    Te = Ce("@observablehq/plot", "0.6.3", "dist/plot.umd.min.js"),
    ...
    Pe = Ce("apache-arrow", "4.0.1", "Arrow.es2015.min.js"),
    ...
    ze = Ce("mermaid", "9.2.2", "dist/mermaid.min.js"),
    We = Ce("leaflet", "1.9.3", "dist/leaflet.js"),
...
function tt(e = "https://cdn.jsdelivr.net/npm/", t = ["unpkg", "jsdelivr", "browser", "main"]) {
    ...
    function n(t) {
        ...
        let r = Ve.get(n);
        return r || Ve.set(n, r = fetch(n).then((e => {
            if (!e.ok) throw new RequireError("unable to load package.json");
            return e.redirected && !Ve.has(e.url) && Ve.set(e.url, r), e.json()
        }))), r
    }
    return async function (r, a) {
        ...
        if (!o.version && null != a && a.startsWith(e)) {
            const t = await n(et(a.substring(e.length)));
            o.version = t.dependencies && t.dependencies[o.name] || t.peerDependencies && t.peerDependencies[o.name]
        }
        if (o.path && !Qe.test(o.path) && (o.path += ".js"), o.path && o.version && Xe.test(o.version)) return `${e}${o.name}@${o.version}/${o.path}`;
        const i = await n(o);
        return `${e}${i.name}@${i.version}/${o.path||function(e){for(const n of t){let t=e[n];if("string"==typeof t)return t.startsWith("./")&&(t=t.slice(2)),Qe.test(t)?t:`${t}.js`}}(i)||"index.js"}`
    }
}
...
function at(e) {
    const t = {};
    for (const n of e)
        for (const e in n) Je.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, {
            get: ot(n, e)
        }) : t[e] = n[e]);
    return t
}
...
function st(e, t, n) {
    ...
    r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), Ge.push(Ze.call(t, it) ? e => {
        const r = {},
            a = {
                exports: r
            };
        return Promise.all(Ye.call(t, (t => "exports" === (t += "") ? r : "module" === t ? a : e(t)))).then((e => (n.apply(null, e), a.exports)))
...
class SQLiteDatabaseClient {
    ...
    async explain(e, t) {
        ...
        }, [mt((await this.query(`EXPLAIN QUERY PLAN ${e}`, t)).map((e => e.detail)).join("\n"))])
    }
    ...
    async describe(e) {
        ...
        return pt("table", {
            value: t
        }, [pt("thead", [pt("tr", n.map((e => pt("th", [mt(e)]))))]), pt("tbody", t.map((e => pt("tr", n.map((t => pt("td", [mt(e[t])])))))))])
    }
    async sql() {
...
function dt(e) {
    return "string" == typeof e ? fetch(e).then(dt) : e instanceof Response || e instanceof Blob ? e.arrayBuffer().then(dt) : e instanceof ArrayBuffer ? new Uint8Array(e) : e
}
...
class Workbook {
    ...
    sheet(e, t) {
        ...
        return function (e, {
            ...
            let c = new Set(["#"]);
            for (let e = r; e <= o; e++) {
                const t = s ? ht(s.findCell(e + 1)) : null;
                let n = t && t + "" || wt(e);
                for (; c.has(n);) n += "_";
                c.add(n)
            }
...
async function _t(e, t, {
    ...
    return ("\t" === t ? n ? _e : ve : n ? we : be)(a, r && ge)
}
class gt {
    constructor(e, t) {
    ...
    async arrow({
        ...
        switch (e) {
            case 4: {
                const [e, t] = await Promise.all([lt(Pe.resolve()), vt(this)]);
                return e.Table.from(t)
            }
            case 9: {
                const [e, t] = await Promise.all([import(`${ct}${Ue.resolve()}`), vt(this)]);
...
var At = Object.freeze({
    ...
    element: function (e, t) {
        ...
        var o = Ct.hasOwnProperty(r) ? document.createElementNS(Ct[r], e) : document.createElement(e);
        if (t)
            for (var i in t) a = (r = i).indexOf(":"), n = t[i], a >= 0 && "xmlns" !== (r = i.slice(0, a)) && (i = i.slice(a + 1)), Ct.hasOwnProperty(r) ? o.setAttributeNS(Ct[r], i, n) : o.setAttribute(i, n);
        return o
    },
    input: function (e) {
...
class DuckDBClient {
    ...
    async queryStream(e, t) {
        ...
        return {
            schema: (o = a.value, o.schema.fields.map(It)),
            async *readRows() {
                try {
    ...
    static async of(e = {}, t = {}) {
        ...
        return void 0 === t.query ?.castTimestampToDate && (t = {
            ...
            if (t instanceof FileAttachment) await Ut(n, e, t);
            else if (Mt(t)) await Dt(n, e, t);
            else if (Array.isArray(t)) await Ft(n, e, t);
            else if (kt(t)) await async function (e, t, n) {
                const r = (await Pt()).tableFromIPC(n.toArrowBuffer());
                return await Dt(e, t, r)
            }(n, e, t);
            else if ("data" in t) {
                const {
                    data: r,
                ...
                Mt(r) ? await Dt(n, e, r, a) : await Ft(n, e, r, a)
            } else {
...
async function Ut(e, t, n, r) {
    ...
    } else await e.registerFileURL(n.name, a);
...
async function Ft(e, t, n, r) {
    const a = (await Pt()).tableFromJSON(n);
    return await Dt(e, t, a, r)
}
...
function Yt(e, t) {
    var n;
    return (n = Gt.get(e = +e)) ? n.then((() => t)) : (n = Date.now()) >= e ? Promise.resolve(t) : function (e, t) {
...
var Zt = Object.freeze({
    ...
    tick: function (e, t) {
        return Yt(Math.ceil((Date.now() + 1) / e) * e, t)
    },
    when: Yt
});
...
function nn(e, t = tn) {
    ...
    if (1 === t.length) {
        ...
        for (const o of e) {
            const e = t(o);
            (r ? tn(e, a) > 0 : 0 === tn(e, e)) && (n = o, a = e, r = !0)
        }
    } else
...
function rn(e) {
    return Array.isArray(e) && (an(e.schema) || (t = e.columns, Array.isArray(t) && t.every((e => "string" == typeof e))) || function (e) {
...
function an(e) {
    return Array.isArray(e) && e.every(on)
}
...
const fn = Object.assign((async (e, t, n, r) => {
    if (e = await pn(await e, r), (a = e) && ("function" == typeof a.sql || "function" == typeof a.queryTag && ("function" == typeof a.query || "function" == typeof a.queryStream)) && ("table" !== o || "function" == typeof a.describeColumns) && a !== fn) return bn(e, function (e, t) {
        ...
        const c = new Map(e.names ?.map((({
            ...
            l = [
                [`SELECT ${r.columns?r.columns.map((e=>{const t=c.get(e);return t?`${n(e)} AS ${n(t)}`:n(e)})).join(", "):"*"} FROM ${wn(a.table,n)}`]
            ];
        for (let e = 0; e < o.length; ++e) yn(e ? "\nAND " : "\nWHERE ", l), _n(o[e], l, n);
        for (let e = 0; e < i.length; ++e) yn(e ? ", " : "\nORDER BY ", l), vn(i[e], l, n);
        if ("mssql" === t.dialect || "oracle" === t.dialect) {
            if (null !== s.to || null !== s.from) {
                ...
                yn(`\nOFFSET ${s.from||0} ROWS`, l), yn(`\nFETCH NEXT ${null!==s.to?s.to-(s.from||0):1e9} ROWS ONLY`, l)
            }
        } else null === s.to && null === s.from || yn("\nLIMIT " + (null !== s.to ? s.to - (s.from || 0) : 1e9), l), null !== s.from && yn(` OFFSET ${s.from}`, l);
        return l
    }(t, e), n);
    var a, o;
    if (rn(e)) return function (e, t) {
        const n = e;
        let {
            schema: r,
            columns: a
        ...
        if (t.types) {
            for (const {
                ...
                i.set(e, a), r === n.schema && (r = r.slice());
        ...
        s = null == s ? 0 : Math.max(0, s), c = null == c ? 1 / 0 : Math.max(0, c), (s > 0 || c < 1 / 0) && (e = e.slice(Math.max(0, s), Math.max(0, c)));
        if (t.select.columns) {
            if (r) {
                const e = new Map(r.map((e => [e.name, e])));
                r = t.select.columns.map((t => e.get(t)))
            }
            a && (a = t.select.columns), e = e.map((e => Object.fromEntries(t.select.columns.map((t => [t, e[t]])))))
        }
        if (t.names) {
            ...
            }))), a && (a = a.map((e => n.get(e) ?.name ?? e))), e = e.map((e => Object.fromEntries(Object.keys(e).map((t => [n.get(t) ?.name ?? t, e[t]])))))
        }
        e !== n && (r && (e.schema = r), a && (e.columns = a));
        return e
    }(e, t);
    ...
    sql: (e, t, n) => async function () {
        return bn(await mn(await e, n), arguments, t)
    }
});
...
function dn(e) {
    ...
    return (n, r) => {
        ...
        let a = t.get(n);
        return (!a || rn(n) && n.length !== a._numRows) && (a = e(n, r), a._numRows = n.length, t.set(n, a)), a
    }
}
const pn = dn((async (e, t) => {
        if (e instanceof FileAttachment) {
            ...
            if (/\.(arrow|parquet)$/i.test(e.name)) return hn(e, t);
            throw new Error(`unsupported file type: ${e.mimeType}`)
        }
        return Mt(e) || kt(e) ? hn(e, t) : rn(e) && sn(e) ? Array.from(e, (e => ({
            value: e
        }))) : e
    })),
    mn = dn((async (e, t) => {
        ...
        return rn(e) ? hn(await async function (e, t) {
            const n = await Pt();
            return sn(e) ? n.tableFromArrays({
                [t]: e
            }) : n.tableFromJSON(e)
        }(e, t), t) : Mt(e) || kt(e) ? hn(e, t) : e
    }));

function hn(e, t = (e instanceof FileAttachment ? function (e) {
...
function _n({
    ...
    if (1 === t.length || "v" === e || "nv" === e) switch (gn(t[0], n, r), e) {
        case "n":
        case "nv":
            return void yn(" IS NULL", n);
        case "nn":
        case "v":
            return void yn(" IS NOT NULL", n);
        default:
    ...
    if (2 !== t.length || ["in", "nin"].includes(e)) {
        ...
        switch (gn(t[0], n, r), e) {
            ...
            let n = !0;
            for (const r of e) n ? n = !1 : yn(",", t), t.push(r.value), t[0].push("")
        }(t.slice(1), n), yn(")", n)
    } else {
        if (["c", "nc"].includes(e)) {
            switch (gn(t[0], n, r), e) {
...
function gn(e, t, n) {
    "column" === e.type ? yn(n(e.value), t) : (t.push(e.value), t[0].push(""))
}
...
function Cn(e, t) {
    return En(e, t) || (e < t ? -1 : e > t ? 1 : 0)
}

function Nn(e, t) {
    return En(e, t) || (e > t ? -1 : e < t ? 1 : 0)
}
const xn = e => "number" == typeof e && !Number.isNaN(e),
    Tn = e => Number.isInteger(e) && !Number.isNaN(e),
    An = e => "string" == typeof e,
    jn = e => "boolean" == typeof e,
    $n = e => "bigint" == typeof e,
    Sn = e => e instanceof Date && !isNaN(e),
    qn = e => e instanceof ArrayBuffer,
    On = e => Array.isArray(e),
    Ln = e => "object" == typeof e && null !== e,
    kn = e => null != e;
...
const In = /^(([-+]\d{2})?\d{4}(-\d{2}(-\d{2}))|(\d{1,2})\/(\d{1,2})\/(\d{2,4}))([T ]\d{2}:\d{2}(:\d{2}(\.\d{3})?)?(Z|[-+]\d{2}:\d{2})?)?$/;
...
function Rn(e, t) {
    switch (t) {
        ...
        case "date": {
            ...
            return "string" != typeof e || t ? new Date(In.test(t) ? t : NaN) : null
        }
        case "array":
        case "object":
        case "buffer":
...
function Pn(e, t, n) {
    ...
    for (const a of n) {
        const n = t.get(a.name),
            o = e[a.name];
        r[a.name] = "raw" === n ? o : Rn(o, n)
    }
    return r
}
const Un = ["boolean", "integer", "number", "date", "bigint", "array", "object", "buffer"];

function Dn(e, t = function (e) {
    const t = new Set;
    for (const n of e)
        if (n)
    ...
    for (const e of t) {
        ...
        for (const n of r) {
            ...
            if ("string" !== a) ++t.defined, Array.isArray(r) ? ++t.array : r instanceof Date ? ++t.date : r instanceof ArrayBuffer ? ++t.buffer : "number" === a ? (++t.number, Number.isInteger(r) && ++t.integer) : a in t && ++t[a];
                ...
                ++t.defined, ++t.string, /^(true|false)$/i.test(r) ? ++t.boolean : r && !isNaN(r) ? (++t.number, Number.isInteger(+r) && ++t.integer) : In.test(r) && ++t.date
            }
        }
        const a = Math.max(1, .9 * t.defined),
            o = nn(Un, (e => t[e] >= a ? t[e] : NaN)) ?? (t.string >= a ? "string" : "other");
        n.push({
            name: e,
            type: o,
            inferred: o
...
const Library = Object.assign(Object.defineProperties((function (e) {
    ...
    Object.defineProperties(this, (n = {
        ...
        svg: () => Kt,
        tex: () => function (e) {
            return Promise.all([e($e.resolve()), e.resolve($e.resolve("dist/katex.min.css")).then(Qt)]).then((function (e) {
                var t = e[0],
                    n = r();
                ...
                function r(e) {
                    return function () {
                        ...
                        return t.render(Xt.apply(String, arguments), n, e), n.removeChild(n.firstChild)
                    }
                }
        ...
        L: () => async function (e) {
            ...
            if (!t._style) {
                ...
                n.rel = "stylesheet", n.href = await e.resolve(We.resolve("dist/leaflet.css")), t._style = document.head.appendChild(n)
            }
            return t
        }(t),
        mermaid: () => async function (e) {
            ...
            return t.initialize({
                ...
                function () {
                    ...
                    return e.innerHTML = t.render(xt().id, String.raw.apply(String, arguments)), e.removeChild(e.firstChild)
                }
        }(t),
        Plot: () => t(Te.resolve()),
        __query: () => fn,
        ...
        vl: () => async function (e) {
            const [t, n, r] = await Promise.all([Me, Ie, Re].map((t => e(t.resolve()))));
        ...
        Generators: Lt,
        Promises: Zt
    }, Object.fromEntries(Object.entries(n).map(Fn))))
}), {
    resolve: {
        get: () => lt.resolve,
        enumerable: !0,
...
const Wn = Array.prototype.map;

function Hn() {}
const Vn = Symbol("no-observer");

function Variable(e, t, n) {
    var r;
    n || (n = Vn), Object.defineProperties(this, {
        _observer: {
            value: n,
            writable: !0
        },
        ...
        _rejector: {
            value: (r = this, e => {
                if (e === Jn) throw e;
                if (e === Zn) throw new RuntimeError(`${r._name} is not defined`, r._name);
...
function Xn(e, t, n) {
    ...
    if (this._inputs.forEach(Yn, this), t.forEach(Gn, this), this._inputs = t, this._definition = n, this._value = void 0, n === Hn ? a._variables.delete(this) : a._variables.add(this), e !== this._name || r.get(e) !== this) {
        let t, o;
        if (this._name)
        ...
        e && ((o = r.get(e)) ? 3 === o._type ? (this._definition = Kn(e), this._duplicate = n, o._duplicates.add(this)) : 2 === o._type ? (this._outputs = o._outputs, o._outputs = new Set, this._outputs.forEach((function (e) {
            e._inputs[e._inputs.indexOf(o)] = this
        }), this), a._dirty.add(o).add(this), r.set(e, this)) : (o._duplicate = o._definition, this._duplicate = n, t = new Variable(3, this._module), t._name = e, t._definition = this._definition = o._definition = Kn(e), t._outputs = o._outputs, o._outputs = new Set, t._outputs.forEach((function (e) {
...
Object.defineProperties(Variable.prototype, {
    ...
    define: {
        value: function (e, t, n) {
            ...
            return Xn.call(this, null == e ? null : String(e), null == t ? [] : Wn.call(t, this._module._resolve, this._module), "function" == typeof n ? n : Bn(n))
        },
        writable: !0,
        configurable: !0
    },
    ...
    import: {
        value: function (e, t, n) {
            ...
            return Xn.call(this, String(t), [n._resolve(String(e))], zn)
        },
        writable: !0,
        configurable: !0
    }
});
const Qn = Symbol("variable"),
    er = Symbol("invalidation"),
    tr = Symbol("visibility");
...
Object.defineProperties(Module.prototype, {
    _resolve: {
        value: function (e) {
            ...
            if (!n)
                if (n = new Variable(2, this), this._builtins.has(e)) n.define(e, Bn(this._builtins.get(e)));
                ...
                void 0 === t ? this._scope.set(n._name = e, n) : n.define(e, Bn(t))
            }
            return n
        },
        writable: !0,
            ...
            for (const e of r)
                ...
                for (const [r, a] of t._scope) {
                    ...
                    if (!t || 2 === t._type)
                        ...
                        } else e.define(r, a._inputs.map(rr), a._definition)
                }
            return i
        },
        writable: !0,
    ...
    value: {
        value: async function (e) {
            ...
            if (!t) throw new RuntimeError(`${e} is not defined`);
            if (t._observer !== Vn) return nr(this._runtime, t);
            t = this.variable(!0).define([e], zn);
            try {
                return await nr(this._runtime, t)
            } finally {
                t.delete()
            }
        },
...
const ar = "function" == typeof requestAnimationFrame ? requestAnimationFrame : "function" == typeof setImmediate ? setImmediate : e => setTimeout(e, 0);

function Runtime(e = new Library, t = pr) {
    const n = this.module();
...
function fr(e) {
    e._invalidate(), e._invalidate = Hn, e._pending();
    const t = e._value,
        n = ++e._version;
    let r = null;
    const a = e._promise = (e._inputs.length ? Promise.all(e._inputs.map(cr)).then((function (a) {
        ...
        if (function (e) {
            ...
            }(t)) return (r || lr(e)).then((a = t, function () {
                a.return()
            })),
            function (e, t, n) {
...
function dr(e, t) {
    e._invalidate(), e._invalidate = Hn, e._pending(), ++e._version, e._indegree = NaN, (e._promise = Promise.reject(t)).catch(Hn), e._value = void 0, e._rejected(t)
}
...
Object.defineProperties(Runtime.prototype, {
    ...
    _computeSoon: {
        value: function () {
            return new Promise(ar).then((() => this._disposed ? void 0 : this._computeNow()))
        },
        writable: !0,
        configurable: !0
    },
    _computeNow: {
        value: async function () {
            ...
            e = new Set(this._dirty), e.forEach((function (t) {
                ...
                e._outputs.forEach(ir)
            }));
            do {
                for (e.forEach((function (e) {
                        0 === e._indegree && n.push(e)
                    })); t = n.pop();) fr(t), t._outputs.forEach(a), e.delete(t);
                e.forEach((function (t) {
                    or(t) && (dr(t, new RuntimeError("circular definition")), t._outputs.forEach(sr), e.delete(t))
                }))
            } while (e.size);
